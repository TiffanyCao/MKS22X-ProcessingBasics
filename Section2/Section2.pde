...
void gasketH(int atLevel, int levels, float v1x, float v1y, float v2x, float v2y, float v3x, float v3y){
  ...
  if(atLevel < levels){
    ...
    if((atLevel + 1) != levels){
      gasketH(atLevel + 1, levels, v1x, v1y, (v1x+v2x)/2, (v1y+v2y)/2, (v1x+v3x)/2, (v1y+v3y)/2);
      gasketH(atLevel + 1, levels, v2x, v2y, (v1x+v2x)/2, (v1y+v2y)/2, (v2x+v3x)/2, (v2y+v3y)/2);
      gasketH(atLevel + 1, levels, v3x, v3y, (v1x+v3x)/2, (v1y+v3y)/2, (v2x+v3x)/2, (v2y+v3y)/2);
    }
  }
}
void draw() { 
